...
public class Core implements Serializable {
	...
	transient MyHttpClient myHttpClient = MyHttpClient.getInstance();
	String uuid = null;
	...
	private Map<String,Integer> openRobot = new HashMap<>();
	...
	public Map<String, Integer> getOpenRobot() {
		return openRobot;
	}

	public void setOpenRobot(Map<String, Integer> openRobot) {
